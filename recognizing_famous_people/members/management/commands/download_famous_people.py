...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        famous_people = {
            ...
            # Stranger Things (easy/medium)
            "Winona Ryder":      ("female", "white", "easy"),
            "David Harbour":     ("male",   "white", "medium"),
            "Finn Wolfhard":     ("male",   "white", "medium"),
            "Noah Schnapp":      ("male",   "white", "medium"),
            "Sadie Sink":        ("female", "white", "medium"),
            "Gaten Matarazzo":   ("male",   "white", "medium"),
            "Caleb McLaughlin":  ("male",   "black", "medium"),
            "Joe Keery":         ("male",   "white", "medium"),
            "Natalia Dyer":      ("female", "white", "medium"),
            "Charlie Heaton":    ("male",   "white", "medium"),
            "Maya Hawke":        ("female", "white", "medium"),

            # Game of Thrones (easy/medium)
            "Emilia Clarke":     ("female", "white", "easy"),
            "Kit Harington":     ("male",   "white", "easy"),
            "Peter Dinklage":    ("male",   "white", "easy"),
            "Sophie Turner":     ("female", "white", "medium"),
            "Maisie Williams":   ("female", "white", "medium"),
            "Lena Headey":       ("female", "white", "medium"),
            "Nikolaj Coster-Waldau": ("male", "white", "medium"),
            "Jason Momoa":       ("male",   "brown", "easy"),
            "Pedro Pascal":      ("male",   "brown", "easy"),

            # Wednesday (medium)
            "Catherine Zeta-Jones": ("female", "white", "easy"),
            "Luis Guzmán":       ("male",   "brown", "medium"),
            "Percy Hynes White": ("male",   "white", "hard"),
            "Emma Myers":        ("female", "white", "hard"),
            "Joy Sunday":        ("female", "black", "hard"),

            # The Witcher (medium)
            "Henry Cavill":      ("male",   "white", "easy"),
            "Anya Chalotra":     ("female", "asian", "medium"),
            "Freya Allan":       ("female", "white", "medium"),
            "Joey Batey":        ("male",   "white", "hard"),

            # Breaking Bad (easy/medium)
            "Bryan Cranston":    ("male",   "white", "easy"),
            "Aaron Paul":        ("male",   "white", "medium"),
            "Bob Odenkirk":      ("male",   "white", "medium"),
            "Giancarlo Esposito": ("male",  "black", "medium"),
            "Jonathan Banks":    ("male",   "white", "medium"),

            # The Last of Us (easy/medium)
            "Bella Ramsey":      ("female", "white", "medium"),
            "Anna Torv":         ("female", "white", "medium"),
            "Gabriel Luna":      ("male",   "brown", "medium"),
            "Merle Dandridge":   ("female", "black", "hard"),
            ...
            # Popular Movies Cast (various difficulties)
            "Justin Timberlake": ("male",   "white", "easy"),
            "Amanda Seyfried":   ("female", "white", "medium"),
            "Jeff Bridges":      ("male",   "white", "easy"),
            "Olivia Wilde":      ("female", "white", "medium"),
            "Garrett Hedlund":   ("male",   "white", "medium"),
            "Tye Sheridan":      ("male",   "white", "medium"),
            "Olivia Cooke":      ("female", "white", "medium"),
            "Ben Mendelsohn":    ("male",   "white", "medium"),
            "Miles Teller":      ("male",   "white", "medium"),
            "Glen Powell":       ("male",   "white", "medium"),
            "Keanu Reeves":      ("male",   "white", "easy"),
            "Laurence Fishburne": ("male",  "black", "easy"),
            "Carrie-Anne Moss":  ("female", "white", "medium"),
            "Hugo Weaving":      ("male",   "white", "medium"),
            "Tommy Lee Jones":   ("male",   "white", "easy"),
            "Emily Blunt":       ("female", "white", "easy"),
            "Sam Worthington":   ("male",   "white", "medium"),
            "Zoe Saldana":       ("female", "brown", "easy"),
            "Sigourney Weaver":  ("female", "white", "easy"),
            "Jennifer Lawrence": ("female", "white", "easy"),
            "Josh Hutcherson":   ("male",   "white", "medium"),
            "Liam Hemsworth":    ("male",   "white", "medium"),
            "Woody Harrelson":   ("male",   "white", "easy"),
            "Elizabeth Banks":   ("female", "white", "medium"),
            "Taron Egerton":     ("male",   "white", "medium"),
            "Colin Firth":       ("male",   "white", "easy"),
            "Mark Strong":       ("male",   "white", "medium"),

            # Additional Marvel Actors (easy/medium)
            "Tom Hiddleston":    ("male",   "white", "easy"),
            "Elizabeth Olsen":   ("female", "white", "easy"),
            "Paul Bettany":      ("male",   "white", "medium"),
            "Benedict Wong":     ("male",   "asian", "medium"),
            "Karen Gillan":      ("female", "white", "medium"),
            "Dave Bautista":     ("male",   "brown", "medium"),
            "Pom Klementieff":   ("female", "asian", "medium"),
            "Sebastian Stan":    ("male",   "white", "medium"),
            "Anthony Mackie":    ("male",   "black", "medium"),
            "Don Cheadle":       ("male",   "black", "medium"),
            "Brie Larson":       ("female", "white", "easy"),
            ...
            "Michael Douglas":   ("male",   "white", "easy"),
            "Michelle Pfeiffer": ("female", "white", "easy"),
            "Benedict Cumberbatch": ("male", "white", "easy"),
            "Rachel McAdams":    ("female", "white", "easy"),
            "Chiwetel Ejiofor":  ("male",   "black", "medium"),
            "Chris Pine":        ("male",   "white", "easy"),
            "Zachary Quinto":    ("male",   "white", "medium"),
            "Karl Urban":        ("male",   "white", "medium"),
